/*********************************************************************
w4verify.c   (c)Copyright Sequiter Software Inc., 1988-1998.
All rights reserved.
...
void verifySwitches( void )
{
   ...
   if( d4switch & 0x800000L )
      d4displayStr( "E4OFF_STRING - No Extedned String CodeBase Error Display", 1 ) ;
   if( d4switch & 0x1000000L )
      d4displayStr( "E4PARM_HIGH - High-level Functional Paramater CodeBase Error Display", 1 ) ;
