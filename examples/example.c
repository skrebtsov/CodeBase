/* d4verify.c (c)Copyright Sequiter Software Inc., 1988-1996.  All rights reserved. */
...
void verifySwitches( void )
{
   ...
   if( d4switch & 0x800000L )
      printf( "E4OFF_STRING - No Extedned String CodeBase Error Display\n" ) ;
   if( d4switch & 0x1000000L )
      printf( "E4PARM_HIGH - High-level Functional Paramater CodeBase Error Display\n" ) ;
